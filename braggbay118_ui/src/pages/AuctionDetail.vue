						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="HighestBid" type="text" placeholder="Enter HighestBid" v-model="auctionToAdd.highestBid"></base-input>
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Auction Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Highest Bid</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="HighestBid" type="text" placeholder="Enter HighestBid" v-model="auctionDetails.highestBid"></input>
																		</div>
						</td>
														</tr>
															<tr> 
